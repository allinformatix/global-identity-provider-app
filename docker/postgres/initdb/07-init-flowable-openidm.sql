...
CREATE DATABASE openidm_workflow;

CREATE USER openidm_workflow_user WITH PASSWORD 'changeme';
-- Optional Rechte zuweisen:
GRANT ALL PRIVILEGES ON DATABASE openidm_workflow TO openidm_workflow_user;

-- Verbinde dich zur Datenbank
\connect openidm_workflow
...
BEGIN
    ...
    LOOP
        EXECUTE format(
            'ALTER TABLE public.%I OWNER TO openidm_workflow_user;',
            tbl.tablename
        );
    END LOOP;
END $$;
...
BEGIN
    ...
    LOOP
        EXECUTE format(
            'ALTER SEQUENCE public.%I OWNER TO openidm_workflow_user;',
            seq.sequencename
        );
    END LOOP;
END $$;
...
BEGIN
    ...
    LOOP
        EXECUTE format(
            'ALTER VIEW public.%I OWNER TO openidm_workflow_user;',
            v.table_name
        );
    END LOOP;
END $$;