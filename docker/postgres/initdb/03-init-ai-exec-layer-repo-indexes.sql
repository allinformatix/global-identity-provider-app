...
CREATE UNIQUE INDEX idx_json_managedobjects_userName ON ai_exec_layer.managedobjects
    ( jsonb_extract_path_text(fullobject, 'userName'), objecttypes_id );
CREATE INDEX idx_json_managedobjects_givenName ON ai_exec_layer.managedobjects
    ( jsonb_extract_path_text(fullobject, 'givenName') );
CREATE INDEX idx_json_managedobjects_sn ON ai_exec_layer.managedobjects
    ( jsonb_extract_path_text(fullobject, 'sn') );
CREATE INDEX idx_json_managedobjects_mail ON ai_exec_layer.managedobjects
    ( jsonb_extract_path_text(fullobject, 'mail') );
CREATE INDEX idx_json_managedobjects_accountStatus ON ai_exec_layer.managedobjects
...
CREATE INDEX idx_json_managedobjects_userName_gin ON ai_exec_layer.managedobjects
  USING gin (jsonb_extract_path_text(fullobject, 'userName') gin_trgm_ops);
CREATE INDEX idx_json_managedobjects_givenName_gin ON ai_exec_layer.managedobjects
  USING gin (jsonb_extract_path_text(fullobject, 'givenName') gin_trgm_ops);
CREATE INDEX idx_json_managedobjects_sn_gin ON ai_exec_layer.managedobjects
  USING gin (jsonb_extract_path_text(fullobject, 'sn') gin_trgm_ops);
CREATE INDEX idx_json_managedobjects_mail_gin ON ai_exec_layer.managedobjects
  USING gin (jsonb_extract_path_text(fullobject, 'mail') gin_trgm_ops);
CREATE INDEX idx_json_managedobjects_accountStatus_gin ON ai_exec_layer.managedobjects
