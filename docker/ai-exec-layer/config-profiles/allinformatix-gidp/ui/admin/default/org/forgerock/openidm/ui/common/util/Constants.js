...
define(["org/forgerock/commons/ui/common/util/Constants"], function (commonConstants) {
    commonConstants.context = window.context || "/ai-exec-layer-app";
    ...
    commonConstants.DOC_URL = "https://ea.forgerock.com/docs/idm/";
    commonConstants.AM_DOC_URL = "https://ea.forgerock.com/docs/am/";
    ...
    commonConstants.MINIMUM_UI_FILTER_LENGTH = 3;
