...
chgPass ds-idrepo-0.ds-idrepo ${ADMIN_PASS} ou=people,ou=identities "uid=idm-admin" ${OPENIDM_IDM_TO_AM_PASSWORD}
chgPass ds-idrepo-0.ds-idrepo ${ADMIN_PASS} ou=admins,ou=identities "uid=idm-repo-user" ${OPENIDM_DS_IDREPO_PASSWORD}
chgPass ds-idrepo-0.ds-idrepo ${ADMIN_PASS} ou=admins,ou=identities "uid=ai-exec-layer-repo-user" ${AI_EXEC_LAYER_DS_IDREPO_PASSWORD}
